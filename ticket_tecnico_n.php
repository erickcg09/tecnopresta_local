...
$codigoCentro = $usuario_azure['codigoPresu'] ?? '';
        ...
        if (!$confirmado) {
            ...
            if (!empty($ticketsExistentes)) {
                ...
                $usuario_id = obtenerOCrearUsuario(
                    $usuario_azure['cedula'],
                    $usuario_azure['nombre'],
                    $usuario_azure['correo']
                );
                ...
                if (!$usuario_id) {
                    ...
                    $dre_id = obtenerIdRegional($usuario_azure['idRegional']);
                    ...
                    if (!$dre_id) {
                        ...
                        if ($ticket_id) {
                            ...
                            echo "<meta http-equiv='refresh' content='2;url={$ruta_regreso}'>";
                        } else {
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <!-- <div class="d-flex justify-content-between align-items-center mb-4">
                    <a href="navegar.php?ruta=plataforma_soporte_n.php" class="btn btn-outline-secondary">
                ...
                <div x-data="ticketTecnicoApp()" x-init="init()" x-cloak>
                    <form method="POST" id="formTicketTecnico">
                        ...
                        <div class="card shadow-sm mb-4">
                            <div class="card-body">
                                <div class="alert alert-info mb-0">
                                    ...
                                    Usuario: <?= htmlspecialchars($usuario_azure['nombre']) ?><br>
                                    Cédula: <?= htmlspecialchars($usuario_azure['cedula']) ?><br>
                                    Centro: <?= htmlspecialchars($usuario_azure['codigoPresu']) ?><br>
                                    Regional: <?= htmlspecialchars($usuario_azure['regional']) ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                                <a href="<?= htmlspecialchars($ruta_regreso) ?>" class="btn btn-secondary">
                                    <i class="bi bi-x-circle me-2"></i>Cancelar
                                </a>
