...
// - Acceso: Restricción absoluta para solo retornar datos asociados a $usuario_id.
...
while ($row = mysqli_fetch_assoc($res_activos)) {
    $row['tipo_nombre'] = $row['tipo'] == 1 ? 'T茅cnico' : 'Administrativo';
    
    // Asignación de colores para diseño y UI (Dirección de Arte)
    ...
    switch($row['estado_id']) {
        ...
        case 7: $color_badge = '#6F42C1'; break; // Virtual - P煤rpura
