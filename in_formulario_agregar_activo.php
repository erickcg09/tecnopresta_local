...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="in_formulario_agregar_equipo.php"><span class="icon icon-undo2"></span> Regresar</a>
      </li>
      <li class="nav-item">
...
<div class="container">
  <div class="row">
    <div class="col-md-6">
      ...
      <br><br>
      <form name="frmactivo" action="in_guardar_activo_general.php" method="post">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#FiltrarContenido').on('input', function() {
        ...
        $.ajax({
          url: 'buscar_activosd.php', // Archivo PHP que maneja la búsqueda
          method: 'GET',
            ...
            response.forEach(function(activo) {
              const row = `
                <tr>
                  ...
                  <td>${activo.color}</td>
                  <td>
                    <a class="btn btn-dark" href="eliminar_activod.php?gps=${activo.id_activo}" role="button">
