...
window.onload = function() {
  ...
  obtienePermisos();
  // 1/03/2023 Se  comenta por nueva directriz de no prestar el equipo con destino la casa del estudiante
  //creaSesionPHP_y_Envia_a_Formulario();
...
function muestraCantidadSolicitudes() {
  ...
  function muestraCantidadPrestamos() {
    ...
    function creaSesionPHP_y_Envia_a_Formulario() {
