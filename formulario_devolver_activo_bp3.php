...
<html lang="es">
  <head>
    ...
    <title>Devolver Activo BP3</title>
  </head>
  <body>
...
<div class="container">
<br><br><p class="h2">Equipo asignado al estudiante</p><br>
<form action="devolver_activo_asignado_bp3.php" method="post">
    <input type="hidden" name="idabp3" value="<?php echo $idabp3;?>">
    <h3>Placa del activo<span class="badge bg-secondary"><?php echo $placa;?></span></h3><br>
    <h3>Serial del activo<span class="badge bg-secondary"><?php echo $serial;?></span></h3><br>    
    <div class="form-check form-switch">
      <input class="form-check-input" type="checkbox" name="devolver" value="Si">
      <label class="form-check-label" for="flexSwitchCheckDefault">Activo devuelto</label>
    </div> <br>
