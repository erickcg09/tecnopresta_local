...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"> <!-- Apertura del main donde se coloca la informacion del panel derecho -->
        ...
        <h2 class="text-center mt-3">Centros educativos que entregaron actas de recepción de equipo tecnológico</h2>
        <table class="table table-bordered table-striped">
            ...
            <tbody class="BusquedaRapida">
                ...
                $sql = "SELECT MIN(id_rae) as id_rae, codigo, MIN(dependencia) as dependencia, COUNT(*) as total_registros
...
ORDER BY codigo ASC";
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                            ...
                            <td><a href='in_actas_institucion.php?codigo={$row['codigo']}&dependencia={$row['dependencia']}'>
