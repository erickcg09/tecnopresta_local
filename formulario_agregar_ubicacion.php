...
<h3>Agregar Ubicaci&oacute;n del Activo</h3><a href="ayuda.html#au">[ <span class="icon icon-lifebuoy"></span> Ayuda ]</a><a>&nbsp;&nbsp;</a> <a href="contactenos.php?rep=Error en Agregar Ubicaci&oacute;n del Activo">[ <span class="icon icon-envelop"></span> Reportar Incidencia / Error ]</a>
<br><br>
...
<table class="table table-hover">
	...
	<th>Placa</th>
	<th>Serial</th>
	<th colspan="4"><button class="btn btn-dark btn-lg btn-block" type="submit" name="btnActualizar"> <span class="icon icon-plus"></span> Ubicaci&oacute;n</button></th>
        <tbody class="BusquedaRapida">
	<?php
$consulta=mysqli_query($link,"SELECT Ta.id_activo, Tg.clase, Tm.marca, Ta.modelo, Tc.color, Tp.id_placa, Tp.placa, Tp.serial, Tp.id_estado, Tp.codigo
		 FROM t_activo Ta
	...
	<tr>
        ...
        <td><a class="btn btn-dark" href="mostrar_ubicacion.php?gps=<?php echo $activos['id_placa']?>" role="button"><span class="icon icon-location2"></span></a></td>
        <td><a class="btn btn-dark" href="portal_editar.php?gps=<?php echo $activos['id_placa']?>" role="button"><span class="icon icon-pencil2"></span></a></td>
	</tr>
	<?php }
	mysqli_close($link);	
	?>
