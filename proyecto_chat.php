...
if ($preguntar && mysqli_num_rows($preguntar) > 0) {
    // Si hay resultados, obtén el valor de 'tipo'
    $respuesta = mysqli_fetch_array($preguntar);
    $bandera = $respuesta['tipo'];
} else {
    // Si no hay resultados, asigna 0 a $bandera
    $bandera = 0;
}
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            <a class="nav-link" aria-current="page" href="plataforma_clientes.php">Regresar</a>
    ...
    <div class="container mt-4">
     ...
     ?>
            ...
            <div class="card-footer bg-white position-absolute w-100 bottom-0 m-0 p-1">
                <form action="guardar_msn_chat.php" method="post">
