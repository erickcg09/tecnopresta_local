...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="menu_inventario_nacional.php"><span class="icon icon-undo2"></span> Inventario</a>
      </li>
      <li class="nav-item">
...
<br>
    <div class="input-group mb-3">
      ...
      >
      <a>&nbsp</a>
      <a href="in_formulario_agregar_activo.php" class="btn btn-dark">
...
window.onload = keepSessionAlive;
  ...
  <script src="js/fajaxbuscarxd.js"></script> <!-- main.js -->
