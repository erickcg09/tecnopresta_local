...
// Consulta SQL
$sql = "SELECT t_instituciones.codigo, t_instituciones.institucion
        FROM t_instituciones
        LEFT JOIN t_in_reportes_firmados ON t_instituciones.codigo = t_in_reportes_firmados.codigo
        WHERE t_in_reportes_firmados.codigo IS NULL";
...
<html lang="es">
  <head>
    ...
    <title>Reporte de instituciones que no entregan certificaci&oacute;n</title>
...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"> <!-- Apertura del main donde se coloca la informacion del panel derecho -->
        ...
        <h2 class="text-center mt-3">Instituciones faltantes por entregar las certificaciones de inventario</h2>
        ...
        <tbody class="BusquedaRapida">
            ...
            if ($total_registros > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row["codigo"]. "</td><td>" . $row["institucion"]. "</td></tr>";
                }
                // Fila de total de registros
                echo "<tr><td colspan='2' class='text-end'><strong>Total de registros: $total_registros</strong></td></tr>";
            } else {
