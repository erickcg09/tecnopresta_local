...
<div class="container">  
  <h3>Instituciones Sin Confirmar Entrega FONATEL</h3><a href="ayuda.html#rla">[ <span class="icon icon-lifebuoy"></span> Ayuda ]</a><a>&nbsp;&nbsp;</a> <a href="contactenos.php?rep=Error en Listado de Activos">[ <span class="icon icon-envelop"></span> Reportar Incidencia / Error ]</a><br><br>
  <form action="" method="POST" enctype="multipart/form-data">  
	<table class="table table-hover">	    
	  <th>Código</th>
    <th>Institución</th>
	  <th><a class="btn btn-dark" href="exportar_excel_sin_confirmacion_fonatel.php" role="button"><span class="icon icon-file-excel"></span> EXCEL</a></th>
    <tbody>  
		<?php			 	
