    ...
    <table class="table table-hover">
        ...
        <?php while ($fila = $resultado->fetch_assoc()): ?>
            <tr>
                ...
                <td><a class="btn btn-dark" href="in_formulario_agregar_placas.php?idx=<?= htmlspecialchars($fila['id_activo']) ?>" role="button"><span class="icon icon-plus"> Placa y Serie</span></a></td>
            </tr>
        <?php endwhile; ?>
        </tbody>
    </table>
