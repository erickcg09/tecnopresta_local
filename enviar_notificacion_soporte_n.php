...
$cedula = $_POST['cedula'];
$ruta_regreso = html_entity_decode($_POST['ruta_regreso'] ?? '', ENT_QUOTES, 'UTF-8');
...
move_uploaded_file($_FILES["resume"]["tmp_name"], $path);
		...
		$redirect_url = 'contactenos_n.php';
		if (!empty($ruta_regreso)) {
		    $redirect_url .= '?ruta_regreso=' . urlencode($ruta_regreso);
		}
		echo '<script language = javascript>
