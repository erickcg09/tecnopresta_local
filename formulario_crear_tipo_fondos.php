...
$tienellave = isset($_SESSION['tipo']) && $_SESSION['tipo'] == 1;
if (!$tienellave) {
  ...
  <div class="container py-4">
    <div class="row">
      <div class="col-lg-6">
        ...
        <div class="card mb-4">
          <div class="card-body">
            <h3 class="card-title">Origen de los fondos</h3>
            <div class="d-flex gap-2 mb-3">
              <a href="ayuda.html#ofa" class="btn btn-outline-primary btn-sm">
                <i class="bi bi-question-circle"></i> Ayuda
              </a>
              <a href="contactenos.php?rep=Error en Origen de fondos" class="btn btn-outline-secondary btn-sm">
                <i class="bi bi-envelope"></i> Reportar Incidencia
              </a>
            </div>

            <form name="frfondo" action="guardar_tipo_fondos.php" method="post" class="needs-validation" novalidate>
              <div class="mb-3">
                <label for="fondos" class="form-label">Origen del fondo</label>
                ...
                <small class="text-muted">Antes de agregar, verifique si ya existe en la lista.</small>
              </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="search-box mb-3">
              ...
              <input type="text" id="FiltrarContenido" class="form-control" placeholder="Buscar origen de fondos...">
            </div>
              ...
              <table class="table table-hover align-middle">
                ...
                <tbody class="BusquedaRapida">
                  ...
                  <tr>
                    ...
                    <td><?php echo htmlspecialchars($tipos['fondos']); ?></td>
                    <td>
                      <div class="d-flex gap-2">
                        <a href="formulario_editar_tipo_fondos.php?gps=<?php echo $tipos['id_fondos']; ?>" class="btn btn-sm btn-outline-primary action-btn" title="Editar">
                          <i class="bi bi-pencil"></i>
                        </a>
                        <a href="eliminar_tipofondos.php?gps=<?php echo $tipos['id_fondos']; ?>" class="btn btn-sm btn-outline-danger action-btn" title="Eliminar" onclick="return confirm('¿Estás seguro que deseas eliminar este registro?');">
      ...
      <div class="col-lg-6 d-none d-lg-block">
        <div class="card h-100">
          <div class="card-body d-flex align-items-center justify-content-center">
            <img src="img/fondos.png" class="funds-img" alt="Tipos de fondos" loading="lazy">
          </div>
        </div>
      </div>
    </div>
