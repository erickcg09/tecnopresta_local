  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="guardar_reporte_soporte_2.php">
          ...
          <input type="hidden" name="funcionario" value="<?php echo $lognombre;?>">
          <input type="hidden" name="correo" value="<?php echo $logcorreo;?>">
          ...
          <input type="hidden" name="dre" value="<?php echo $regionallog;?>">
