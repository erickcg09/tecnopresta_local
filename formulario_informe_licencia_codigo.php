...
<h3>Listado de Licencias por Dependencia </h3><a href="ayuda.html#rlld">[ <span class="icon icon-lifebuoy"></span> Ayuda ]</a><a>&nbsp;&nbsp;</a> <a href="contactenos.php?rep=Error en Listadode Licencias por Dependencia">[ <span class="icon icon-envelop"></span> Reportar Incidencia / Error ]</a><br><br>
...
<div class="input-group mb-3">
	...
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
     	  ...
     	  <div class="col-md-4">
     			...
     			<input type="text" name="centro" id="centro" class="form-control " autocomplete="off" placeholder="Ingrese el código presupuestario" /> 
         	<ul class="list-group">
         	</ul>
   	      </div>
...
<table class="table table-hover">
   ...
   <th>Serial</th>
	...
	<th><a class="btn btn-info" href="exportar_l_c.php?codigop=<?php echo$logcodigo;?>" role="button"><span class="icon icon-file-pdf"></span> PDF</a></th>
	<th><a class="btn btn-info" href="exportar_l_excel.php?codigop=<?php echo$logcodigo;?>" role="button"><span class="icon icon-file-excel"></span> EXCEL</a></th>
