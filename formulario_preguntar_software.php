...
<html lang="es">
<head>
  <title>TecnoPresta Reporte de Licencia</title>
...
<div class="container">
      ...
      <div class="row">
		...
		<h3>Reporte de Vencimiento de Licencia </h3><a href="ayuda.html#ale">[ <span class="icon icon-lifebuoy"></span> Ayuda ]</a><a>&nbsp;&nbsp;</a> <a href="contactenos.php?rep=Error en Agregar Licencia a Equipo">[ <span class="icon icon-envelop"></span> Reportar Incidencia / Error ]</a><br><br>
		<form action="dar_pase_informe.php" method="post" >
		<form>
		  ...
		  <button type="submit" class="btn btn-dark"><span class="icon icon-search"> Ver</span></button>
		</form>
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
        </div>
        <div class="col-md-6" style="background-image: url('img/vigencia.png'); background-repeat: no-repeat fixed; background-size: 100% 100%;">
