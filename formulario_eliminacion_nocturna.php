...
<div class="container mt-5">
    ...
    <h4>Formulario para seleccionar activos a eliminar. Recuerde que este proceso se ejecutará en horario nocturno. Los cambios no serán inmediatos, pero serán irreversibles.</h4>
    <div class="mb-3">
...
<script>
    document.getElementById('fondos').addEventListener('change', function() {
        ...
        if (fondosId != 0) {
            ...
            xhr.open('POST', 'datos_seleccionados_para_eliminar.php', true);
