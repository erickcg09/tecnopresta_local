...
// Consulta SQL
$sql = "SELECT codigo, institucion FROM t_instituciones";
...
<html lang="es">
  <head>
    ...
    <title>Reporte inventario institucional</title>
...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"> <!-- Apertura del main donde se coloca la informacion del panel derecho -->
        ...
        <h2 class="text-center mt-3">Listado de centros educativos</h2>
            ...
            <tbody class="BusquedaRapida">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        echo "<tr><td>" . $row["codigo"]. "</td><td>" . $row["institucion"]. "</td><td><a href='in_generar_reporte_institucion_filtrado.php?codigo=" . $row["codigo"] . "' class='btn btn-primary'>Generar Reporte</a></td></tr>";
                    }
                } else {
