...
if ($conteo > 1) {
  echo '<script language = javascript>
	alert("Para agregar la(s) placa(s) debe seleccionar solo un dispositivo")
	self.location = "formulario_agregar_equipo.php"
	</script>';
}
...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="formulario_agregar_equipo.php"><span class="icon icon-undo2"></span> Seleccionar Activo</a>
      </li> 
      <li class="nav-item">
...
<br>
        <div class="container">  
          <div class="row">
            <div class="col-xl">
                <h3 align="center">Agregar serial y placa para el dispositivo: <?php echo $clase . " " . $marca . " " . $modelo . " " . $color?></h3><br /> 
             <form id="frminformacion">
                <label>Ingrese el serial</label>  
                <input type="text" name="serial" id="serial" class="form-control" placeholder="Escriba aqui el serial" pattern=".{5,50}" required/><br /> 
                <label>Ingrese la placa</label>  
                <input type="text" name="placa" id="placa" class="form-control" placeholder="Escriba aqui la placa" pattern=".{5,50}" required/><br />
...
<div class="input-group mb-3">
  ...
  <select id="myDropdownAlias" name="alias">
                          <option value="0">Seleccione:</option>   
    			<?php  
        		...
        		<option value="<?php echo $regr2['alias_id']; ?>" data-imagesrc="img/alias/<?php echo $regr2['alias_imagen']; ?>"
 ...
 <div class="input-group mb-3">
    <div class="input-group-prepend">
      <label for="exampleInputEmail1">N&uacute;mero del equipo</label>
    </div>  
    <input type="text" class="form-control" id="numero" name="numero" aria-describedby="numeroAyuda">
