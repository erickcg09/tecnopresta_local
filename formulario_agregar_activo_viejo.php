...
<h3>Agregar Modelo de Activo</h3><a href="ayuda.html#mg">[ <span class="icon icon-lifebuoy"></span> Ayuda ]</a> <a>&nbsp;&nbsp;</a> <a href="contactenos.php?rep=Error en Agregar Modelo de Activo">[ <span class="icon icon-envelop"></span> Reportar Incidencia / Error]</a>
<br><br>
...
<div class="form-group">
 <input type="hidden" id="marca" name="marca" required>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-group mx-sm-3 mb-2" id="modelo" name="modelo" aria-describedby="modeloAyuda" required onkeypress="return event.charCode != 39">
