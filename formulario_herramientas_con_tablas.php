...
<div class="container">
      ...
      <h2 class="mb-5">Consultar activos por centro educativo</h2>

        
<form action="formulario_activos_por_centro.php" method="POST">
    <div class="mb-3">
        <label for="centro" class="form-label">Código presupuestario del centro educativo</label>
        <input type="text" class="form-control w-25" id="centro" name="centro" required>
    </div>
