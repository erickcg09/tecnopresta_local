...
$ruta_regreso = 'navegar.php?ruta=in_formulario_agregar_modelo_placa_serie_N.php';
  ...
  <main class="flex-grow-1">
    ...
    <div class="card asset-card mb-4 border-primary">
        ...
        <div class="row g-0">
            ...
            <div class="col-md-4">
                <div class="p-2 h-100 d-flex align-items-center justify-content-center position-relative" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
            ...
            <div class="col-md-8">
                <div class="card-body asset-details ps-0">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="detail-item mb-2">
                                <div class="bg-light text-dark rounded p-2 w-100">
