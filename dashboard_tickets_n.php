...
//Validar que vengan los parámetros necesarios para construir la ruta de regreso a plataforma_soporte_n.php
...
<head>
    ...
    <style>
        ...
        .ticket-card {
            border: none;
            border-bottom: 3px solid var(--mep-blue) !important;
        ...
        .ticket-card:hover {
            border-top: 3px solid transparent;
            border-top-color: var(--mep-gold, var(--mep-blue));
            border-left-color: var(--mep-gold);
            border-right-color: var(--mep-gold);
            transform: translateY(-4px);
            box-shadow: 0 8px 24px rgba(0, 56, 118, .10) !important;
            cursor: pointer;
        }
...
<body class="layout-page">
    ...
    <main class="container py-5 contenido-principal" x-data="ticketsDashboard()" x-init="cargarTickets()">
    ...
    <script>
        function ticketsDashboard() {
            return {
                ...
                async cargarTickets() {
                    try {
                        const res = await fetch('ajax/tickets_listar_n.php');
                ...
                async enviarValoracion(ticketId) {
                    ...
                    try {
                        const res = await fetch('ajax/tickets_valorar_n.php', {
                            method: 'POST',
