...
<!-- <script>
    // Función para obtener la foto de perfil desde Azure y actualizar el avatar en el header
    document.addEventListener("DOMContentLoaded", async function () {
    // Captura la imagen del header
    ...
    try {
        // Obtiene foto desde Azure
        const foto = await obtenerFotoPerfil();
        // Validar si vino con contenido real
        if (foto && foto.trim() !== "") {
            img.src = foto; // Reemplaza con foto real
        } else {
            img.src = avatarDefault; // Mantiene avatar
        }
