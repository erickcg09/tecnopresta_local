  ...
  <body class="layout-page">
    ...
    <div class="container">
      ...
      <div class="solicitud-titulo-seccion">
        <h3><i class="bi bi-arrow-return-left"></i> Artículos Prestados o para Recibir</h3>
        <a href="navegar.php?ruta=contactenos_n.php&rep=Error en formulario vista devolucion html" class="reporte-link">
   ...
   <!-- Optional JavaScript -->
    ...
    <script src="js/formulario_VistaDevolucion_n.js?version=5"></script>
