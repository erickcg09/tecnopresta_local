...
$codigo_consultar = $_POST['codigo'];
$inicio_consultar = $_POST['inicio'];
$corte_consultar = $_POST['corte'];
$activado = 1;
...
<div class="container">
 ...
 <div id="imprimible">
        ...
        <h3> Reporte de Préstamos tramitados y reservas futuras </h3>
   ...
   $consulta=mysqli_query($link,"SELECT solicitud_Id, solicitud_nombre_funcionario, solicitud_fechaRetiro, solicitud_fechaDevolucion, solicitud_horaRetiro, solicitud_horaDevolucion, solicitud_uso
		 FROM t_solicitud
		 WHERE solicitud_fechaRetiro BETWEEN '".$inicio_consultar."' AND  '".$corte_consultar."' AND solicitud_codigo_presupuestario = '".$codigo_consultar."' AND solicitud_aprobada = '".$activado."'
		 ORDER BY solicitud_Id") or die(mysqli_error($link));
