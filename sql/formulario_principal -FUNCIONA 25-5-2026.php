 ...
 *  - Validar roles por código presupuestario
 *  - Asignar rol inicial desde T_Lista_Blanca Solo si el usuario NO tiene registros en "usuarios_roles"
 *  - Construción del menú Dinámico
 *  - Retrornar JSON del menú y permisos
...
function obtenerRolesUsuario(PDO $conexionBD, int $usuarioId, string $codigoPresu): array { //: array indica que la función puede devolver un arreglo (si se encuentra el rol) 
    ...
    $sql = "SELECT u.id, u.rol_id, u.subsistema_id, u.codigo_presu, r.rol
