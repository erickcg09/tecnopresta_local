...
class Email_Solicitud
{
                                    ...
                                    $seccionDescripcion) 
    {
        ...
        if(!empty($arrayNombreActivos)) {
    
            if (count($arrayNombreActivos)== 1) {
    
                foreach($arrayNombreActivos as $key => $nombre) {
                    $txtNombresActivos =  $nombre;
                }                
    
            } else {
                
                    foreach($arrayNombreActivos as $key => $nombre) {
                        $txtNombresActivos = $txtNombresActivos . " / " . $nombre . " ";
                    }
            }
        }
        ...
        if(!empty($arrayNombreAlias)) {
            ...
            if (count($arrayNombreAlias)== 1) {
                ...
                foreach($arrayNombreAlias as $key => $nombre) {
                    ...
                    foreach($arrayNombreAlias as $key => $nombre) {
                        $txtNombresAlias = $txtNombresActivos . " / " . $nombre . " ";
                    }
            }
        }
