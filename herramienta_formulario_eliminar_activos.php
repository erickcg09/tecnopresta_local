...
<div class="container mt-5">
    ...
    <h4>Formulario para seleccionar activos a eliminar de los centros educativos.</h4>
    ...
    <form action="herramienta_eliminar_activos.php" method="POST">
...
function cargarActivos() {
    ...
    xhr.open('POST', 'herramienta_datos_seleccionados_para_eliminar.php', true);
