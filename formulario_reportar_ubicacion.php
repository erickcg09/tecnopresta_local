...
<h3>Agregar Ubicaci&oacute;n del Activo</h3>


<form action="guardar_ubicacion.php" method="post">
  <div class="form-group">
    <input type="hidden" class="form-control" name="idsplacas" value="<?php echo implode(",", $idsplacas); ?>">
  </div>
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="cbx_edificio" id="cbx_edificio" class="custom-select"></select>
                </div>
                <div class="form-group">
                    <label for="cbx_estancia">Estancia</label>
                    <select name="cbx_estancia" id="cbx_estancia" class="custom-select"></select>
                </div>
	        <div class="form-group">
	          <label for="cubiculo">Cubículo /  Otro</label>
	          <input type="cubiculo" class="form-control" id="cubiculo" name="cubiculo" aria-describedby="cubiculoHelp">
...
<div class="d-none d-sm-none d-md-block"><img src="img/Ubicacion de Activo-02.png "width="600" height="600"></div>
