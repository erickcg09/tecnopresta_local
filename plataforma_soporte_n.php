...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="flex-grow-1">
        ...
        <div class="container">
            ...
            <a href="dashboard_tickets_n.php<?= (isset($_GET['subsistema_id'], $_GET['modulo_id'])) ? '?subsistema_id=' . intval($_GET['subsistema_id']) . '&amp;modulo_id=' . intval($_GET['modulo_id']) : '' ?>" class="btn-mis-tickets" id="btnMisTickets" data-tooltip="Mis tickets" style="bottom: 100px;">
...
<a href="<?= htmlspecialchars($ruta_regreso) ?>" class="btn-disponibilidad" data-tooltip="Regresar">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-footer border-0 px-4 pb-4 pt-2">
                    ...
                    <a href="ticket_administrativo_n.php<?= (isset($_GET['subsistema_id']) && isset($_GET['modulo_id'])) ? '?subsistema_id=' . intval($_GET['subsistema_id']) . '&amp;modulo_id=' . intval($_GET['modulo_id']) : '' ?>" class="btn btn-primary btn-continuar px-4">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-footer border-0 px-4 pb-4 pt-2">
                    ...
                    <a href="ticket_tecnico_n.php<?= (isset($_GET['subsistema_id']) && isset($_GET['modulo_id'])) ? '?subsistema_id=' . intval($_GET['subsistema_id']) . '&amp;modulo_id=' . intval($_GET['modulo_id']) : '' ?>" class="btn btn-warning btn-continuar px-4">
                        Continuar <i class="bi bi-arrow-right ms-2"></i>
                    </a>
                </div>
            </div>
    ...
    <script>
        ...
        fetch('ajax/tickets_contar_n.php')
