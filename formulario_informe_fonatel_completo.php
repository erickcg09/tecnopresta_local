...
<div class="container">  
  <h3>Instituciones Entrega Completa FONATEL</h3><a href="ayuda.html#rla">[ <span class="icon icon-lifebuoy"></span> Ayuda ]</a><a>&nbsp;&nbsp;</a> <a href="contactenos.php?rep=Error en Listado de Activos">[ <span class="icon icon-envelop"></span> Reportar Incidencia / Error ]</a><br><br>
  <form action="" method="POST" enctype="multipart/form-data">  
    ...
    <th>Cédula</th>
    <th>Responsable</th>
	<th><a class="btn btn-dark" href="exportar_excel_fonatel_completo.php" role="button"><span class="icon icon-file-excel"></span> EXCEL</a></th>
    <tbody>  
		<?php			 	
   			$consulta=mysqli_query($link,"SELECT * FROM t_confirmacion_entrega_fonatel where completo = 1") 
