...
<html lang="es">
  <head>
    ...
    <title>Instituciones dispuestas a donar activos</title>
...
<h2 class = "text-center mt-3">Instituciones dispuestas a donar equipo muy bueno o bueno</h2>
...
$(document).ready(function() {
    $('#fondos').change(function() {
        ...
        $.ajax({
            url: 'in_consulta_activos_donar.php',
            type: 'POST',
