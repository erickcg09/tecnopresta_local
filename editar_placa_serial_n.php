...
if ($row['count'] > 0) {
    ...
    header('Location: navegar.php?ruta=formulario_editar_placa_n.php&error=duplicado&id='.$id_placa);
    exit();
}
...
if (mysqli_query($link, $update)) {
    ...
    header('Location: navegar.php?ruta=formulario_editar_placa_n.php&success=1&id='.$id_placa);
} else {
    // Redirigir con mensaje de error
    header('Location: navegar.php?ruta=formulario_editar_placa_n.php&error=actualizacion&id='.$id_placa);
}
