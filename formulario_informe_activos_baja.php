...
<div class="container">
	  ...
	  <h3>Usuario: <?php echo $lognombre; ?> </h3><br>
        ...
        <h3> Listado de Activos Dados de Baja </h3><a href="ayuda.html#rladb">[ <span class="icon icon-lifebuoy"></span> Ayuda ]</a><a>&nbsp;&nbsp;</a> <a href="contactenos.php?rep=Error en Listado de Activos Dados de Baja">[ <span class="icon icon-envelop"></span> Reportar Incidencia / Error ]</a><br><br>
...
<form action="" method="POST" enctype="multipart/form-data">
   ...
   <th>Color</th>
	...
	<th>Cédula</th>
	<th>Nombre</th>
	<th><a class="btn btn-info" href="exportar_activo_baja.php?codigop=<?php echo$logcodigo?>&b_estadop=<?php echo$b_estado?>&estadop=<?php echo$estado?>&dependenciap=<?php echo$logdependencia?>" role="button"><span class="icon icon-file-pdf"></span> PDF</a></th>
	<th><a class="btn btn-info" href="exportar_activo_baja_ex.php?codigop=<?php echo$logcodigo?>&b_estadop=<?php echo$b_estado?>&estadop=<?php echo$estado?>&dependenciap=<?php echo$logdependencia?>" role="button"><span class="icon icon-file-excel"></span> EXCEL</a></th>
