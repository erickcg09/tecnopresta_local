...
<body>
    <nav class="navbar navbar-expand-md bg-dark navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="formulario_menu_inventario.html"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-reply-all" viewBox="0 0 16 16">
    ...
    <div class="container mt-5">
        ...
        <form action="enviar_notificacion_push_personalizada.php" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="mensaje" class="form-label">Mensaje de la Notificación</label>
                <textarea class="form-control w-50" id="mensaje" name="mensaje" rows="3" required></textarea>
            </div>
        ...
        <?php if (isset($_GET['status']) && $_GET['status'] === 'success'): ?>
            <div class="alert alert-success" role="alert">
                ¡La notificación se envió con éxito a todos los suscriptores!
            </div>
        <?php elseif (isset($_GET['status']) && $_GET['status'] === 'error'): ?>
            <div class="alert alert-danger" role="alert">
                Error al enviar la notificación: <?php echo htmlspecialchars($_GET['msg']); ?>
            </div>
        <?php endif; ?>
<br><br><br>        
