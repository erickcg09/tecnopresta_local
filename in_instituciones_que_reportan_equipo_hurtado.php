...
<html lang="es">
  <head>
    ...
    <title>Instituciones que reportan equipo hurtado o robado</title>
...
<h2 class = "text-center mt-3">Instituciones que reportan equipo hurtado o robado</h2>
...
$(document).ready(function() {
    $('#fondos').change(function() {
        ...
        $.ajax({
            url: 'in_consulta_activos_hurtados.php',
            type: 'POST',
