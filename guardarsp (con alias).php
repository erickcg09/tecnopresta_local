...
$result = $link->query($sql);
	...
	if ($result->num_rows >= 1) {
		  ...
		  $consulta = "INSERT INTO t_placa (placa,serial,id_activo,codigo,id_estado,prestar,activo,id_fondos, alias_id, numero_activo)VALUES('$placa','$serial',$activo,$codigo,$estado,$prestar,$activado,$fondos, $alias_id, $numero)";
